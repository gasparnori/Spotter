...
class Ui_tab_features(object):
    def setupUi(self, tab_features):
        ...
        self.page_feature_detection.setGeometry(QtCore.QRect(0, 0, 811, 569))
        ...
        self.FilterSettings = QtGui.QGroupBox(self.page_feature_detection)
        self.FilterSettings.setObjectName(_fromUtf8("FilterSettings"))
        self.gridLayoutWidget = QtGui.QWidget(self.FilterSettings)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(0, 20, 301, 107))
        self.gridLayoutWidget.setObjectName(_fromUtf8("gridLayoutWidget"))
        self.gridLayout_8 = QtGui.QGridLayout(self.gridLayoutWidget)
        self.gridLayout_8.setMargin(0)
        self.gridLayout_8.setObjectName(_fromUtf8("gridLayout_8"))
        self.filterLabel = QtGui.QLabel(self.gridLayoutWidget)
        self.filterLabel.setObjectName(_fromUtf8("filterLabel"))
        self.gridLayout_8.addWidget(self.filterLabel, 2, 0, 1, 1)
        self.autosetLabel = QtGui.QLabel(self.gridLayoutWidget)
        self.autosetLabel.setObjectName(_fromUtf8("autosetLabel"))
        self.gridLayout_8.addWidget(self.autosetLabel, 1, 0, 1, 1)
        self.filterMaxLabel = QtGui.QLabel(self.gridLayoutWidget)
        self.filterMaxLabel.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTop|QtCore.Qt.AlignTrailing)
        self.filterMaxLabel.setObjectName(_fromUtf8("filterMaxLabel"))
        self.gridLayout_8.addWidget(self.filterMaxLabel, 3, 2, 1, 1)
        self.label = QtGui.QLabel(self.gridLayoutWidget)
        self.label.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.label.setObjectName(_fromUtf8("label"))
        self.gridLayout_8.addWidget(self.label, 3, 1, 1, 1)
        self.filterSlider = QtGui.QSlider(self.gridLayoutWidget)
        self.filterSlider.setMinimum(1)
        self.filterSlider.setMaximum(999)
        self.filterSlider.setSingleStep(10)
        self.filterSlider.setOrientation(QtCore.Qt.Horizontal)
        self.filterSlider.setObjectName(_fromUtf8("filterSlider"))
        self.gridLayout_8.addWidget(self.filterSlider, 2, 1, 1, 2)
        self.btn_filter = QtGui.QPushButton(self.gridLayoutWidget)
        self.btn_filter.setObjectName(_fromUtf8("btn_filter"))
        self.gridLayout_8.addWidget(self.btn_filter, 1, 1, 1, 1)
        self.verticalLayout_4.addWidget(self.FilterSettings)
        self.enable_filter = QtGui.QCheckBox(self.page_feature_detection)
        self.enable_filter.setObjectName(_fromUtf8("enable_filter"))
        self.verticalLayout_4.addWidget(self.enable_filter)
        self.enable_adaptive = QtGui.QCheckBox(self.page_feature_detection)
        self.enable_adaptive.setEnabled(False)
        self.enable_adaptive.setObjectName(_fromUtf8("enable_adaptive"))
        self.verticalLayout_4.addWidget(self.enable_adaptive)
        self.ckb_prediction = QtGui.QCheckBox(self.page_feature_detection)
        self.ckb_prediction.setEnabled(False)
        self.ckb_prediction.setChecked(False)
        self.ckb_prediction.setObjectName(_fromUtf8("ckb_prediction"))
        self.verticalLayout_4.addWidget(self.ckb_prediction)
        self.gridLayout_12 = QtGui.QGridLayout()
        self.gridLayout_12.setObjectName(_fromUtf8("gridLayout_12"))
        self.sensorProgress = QtGui.QProgressBar(self.page_feature_detection)
        self.sensorProgress.setProperty("value", 24)
        self.sensorProgress.setObjectName(_fromUtf8("sensorProgress"))
        self.gridLayout_12.addWidget(self.sensorProgress, 1, 1, 1, 1)
        self.CalibRBtn = QtGui.QPushButton(self.page_feature_detection)
        self.CalibRBtn.setObjectName(_fromUtf8("CalibRBtn"))
        self.gridLayout_12.addWidget(self.CalibRBtn, 1, 0, 1, 1)
        self.CalibQBtn = QtGui.QPushButton(self.page_feature_detection)
        self.CalibQBtn.setObjectName(_fromUtf8("CalibQBtn"))
        self.gridLayout_12.addWidget(self.CalibQBtn, 2, 0, 1, 1)
        self.measurementProgress = QtGui.QProgressBar(self.page_feature_detection)
        self.measurementProgress.setProperty("value", 24)
        self.measurementProgress.setObjectName(_fromUtf8("measurementProgress"))
        self.gridLayout_12.addWidget(self.measurementProgress, 2, 1, 1, 1)
        ...
        self.page_feature_IO.setGeometry(QtCore.QRect(0, 0, 811, 569))
    ...
    def retranslateUi(self, tab_features):
        ...
        self.FilterSettings.setTitle(_translate("tab_features", "Filter Settings", None))
        self.filterLabel.setText(_translate("tab_features", "Refine filter", None))
        self.autosetLabel.setText(_translate("tab_features", "Autoset filter", None))
        self.filterMaxLabel.setText(_translate("tab_features", "smoother", None))
        self.label.setText(_translate("tab_features", "more precise", None))
        self.filterSlider.setToolTip(_translate("tab_features", "<html><head/><body><p>The higher the value, the more smooth the movement</p></body></html>", None))
        self.filterSlider.setWhatsThis(_translate("tab_features", "<html><head/><body><p>Here you can set the observation covariance for the Kalman filter</p></body></html>", None))
        self.btn_filter.setText(_translate("tab_features", "Recalibrate", None))
        self.enable_filter.setText(_translate("tab_features", "Enable Kalman Filter", None))
        self.enable_adaptive.setText(_translate("tab_features", "Adaptive filtering", None))
        self.ckb_prediction.setText(_translate("tab_features", "Estimating position", None))
        self.CalibRBtn.setText(_translate("tab_features", "Calibrate Sensor error", None))
        self.CalibQBtn.setText(_translate("tab_features", "Calibrate Observation error", None))
