...
class Ui_tab_features(object):
    def setupUi(self, tab_features):
        ...
        self.page_feature_detection.setGeometry(QtCore.QRect(0, 0, 312, 343))
        ...
        self.ckb_kalmanfilter = QtGui.QCheckBox(self.page_feature_detection)
        self.ckb_kalmanfilter.setChecked(True)
        self.ckb_kalmanfilter.setObjectName(_fromUtf8("ckb_kalmanfilter"))
        self.gridLayout_3.addWidget(self.ckb_kalmanfilter, 2, 1, 1, 1)
        ...
        self.page_feature_IO.setGeometry(QtCore.QRect(0, 0, 312, 343))
    ...
    def retranslateUi(self, tab_features):
        ...
        self.ckb_kalmanfilter.setText(_translate("tab_features", "Estimating position", None))
