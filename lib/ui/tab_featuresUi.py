...
class Ui_tab_features(object):
    def setupUi(self, tab_features):
        ...
        self.groupBox = QtGui.QGroupBox(self.page_feature_detection)
        self.groupBox.setMinimumSize(QtCore.QSize(0, 100))
        self.groupBox.setObjectName(_fromUtf8("groupBox"))
        self.gridLayoutWidget = QtGui.QWidget(self.groupBox)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(0, 20, 231, 69))
        self.gridLayoutWidget.setObjectName(_fromUtf8("gridLayoutWidget"))
        self.gridLayout_10 = QtGui.QGridLayout(self.gridLayoutWidget)
    ...
    def retranslateUi(self, tab_features):
        ...
        self.groupBox.setTitle(_translate("tab_features", "Filter settings", None))
