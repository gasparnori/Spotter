...
class Ui_tab_features(object):
    def setupUi(self, tab_features):
        ...
        self.recalibrateBtn = QtGui.QPushButton(self.page_feature_detection)
        self.recalibrateBtn.setObjectName(_fromUtf8("recalibrateBtn"))
        self.verticalLayout_4.addWidget(self.recalibrateBtn)
    ...
    def retranslateUi(self, tab_features):
        ...
        self.recalibrateBtn.setText(_translate("tab_features", "Recalibrate filter", None))
