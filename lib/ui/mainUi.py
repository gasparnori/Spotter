...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/camera_on_red.ico")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/camera_off.png")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actionCamera.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/play_file.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/stop_file.png")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actionFile.setIcon(icon3)
        self.actionFile.setObjectName(_fromUtf8("actionFile"))
        self.actionSave = QtGui.QAction(MainWindow)
        self.actionSave.setEnabled(False)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/save-icon.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/about_icon.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/stop_file.png")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8(":/load_template.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionLoadConfig.setIcon(icon8)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(_fromUtf8(":/remove_config.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRemoveTemplate.setIcon(icon9)
