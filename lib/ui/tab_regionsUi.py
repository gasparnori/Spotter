...
class Ui_tab_regions(object):
    def setupUi(self, tab_regions):
        ...
        self.table_slots.setColumnCount(4)
        ...
        item = QtGui.QTableWidgetItem()
        self.table_slots.setHorizontalHeaderItem(3, item)
        ...
        self.gridLayout_10.addWidget(self.table_slots, 6, 0, 1, 1)
        ...
        self.gridLayout_5.addLayout(self.gridLayout_10, 28, 0, 1, 2)
        ...
        self.LineBtn = QtGui.QRadioButton(self.page_regions_overview)
        self.LineBtn.setObjectName(_fromUtf8("LineBtn"))
        self.gridLayout_5.addWidget(self.LineBtn, 17, 0, 1, 1)
        self.RectBtn = QtGui.QRadioButton(self.page_regions_overview)
        self.RectBtn.setObjectName(_fromUtf8("RectBtn"))
        self.gridLayout_5.addWidget(self.RectBtn, 7, 0, 1, 1)
        self.CircleBtn = QtGui.QRadioButton(self.page_regions_overview)
        self.CircleBtn.setObjectName(_fromUtf8("CircleBtn"))
        self.gridLayout_5.addWidget(self.CircleBtn, 7, 1, 1, 1)
    ...
    def retranslateUi(self, tab_regions):
        ...
        item.setText(_translate("tab_regions", "Enabled", None))
        ...
        item = self.table_slots.horizontalHeaderItem(3)
        ...
        self.LineBtn.setText(_translate("tab_regions", "Line", None))
        self.RectBtn.setText(_translate("tab_regions", "Rectangle", None))
        self.CircleBtn.setText(_translate("tab_regions", "Circle", None))
