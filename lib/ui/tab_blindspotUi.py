...
class Ui_tab_regions(object):
    def setupUi(self, tab_regions):
        ...
        self.gridLayout_5.addLayout(self.gridLayout_10, 20, 0, 1, 2)
        ...
        self.gridLayout_5.addWidget(self.btn_add, 8, 1, 1, 1)
