...
class Ui_tab_markers(object):
    def setupUi(self, tab_markers):
        ...
        self.ckb_prediction = QtGui.QCheckBox(self.page_marker_detection)
        ...
        self.sensorProgress = QtGui.QProgressBar(self.page_marker_detection)
    ...
    def retranslateUi(self, tab_markers):
        ...
        self.FilterSettings.setTitle(_translate("tab_markers", "Filter Settings", None))
